              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 text-xs">
                      <span className="px-2 py-1 bg-green-100 text-green-700 rounded">Machine Learning</span>
                      <span className="text-gray-500">2024</span>
                    </div>
                  </div>
                </div>
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 text-xs">
                      <span className="px-2 py-1 bg-blue-100 text-blue-700 rounded">Fintech</span>
                      <span className="text-gray-500">Active</span>
                    </div>
                  </div>
                </div>
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 text-xs">
                      <span className="px-2 py-1 bg-purple-100 text-purple-700 rounded">Blockchain</span>
                      <span className="text-gray-500">Beta</span>
                    </div>
                  </div>
                </div>
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 text-xs">
                      <span className="px-2 py-1 bg-red-100 text-red-700 rounded">Healthcare</span>
                      <span className="text-gray-500">2023</span>
                    </div>
                  </div>
                </div>
            ...
            {hoveredProject === 'ai-platform' ? (
              <div className="max-w-lg w-full p-8">
                ...
                <div className="space-y-3">
                  <div>
                    <span className="font-medium text-gray-700">Timeline:</span>
                    <span className="ml-2 text-gray-600">Jan 2024 - Jun 2024</span>
                  </div>
                  <div>
                    <span className="font-medium text-gray-700">Status:</span>
                    <span className="ml-2 text-gray-600">2024</span>
                  ...
                  <div>
                    <span className="font-medium text-gray-700">My Role:</span>
                    <span className="ml-2 text-gray-600">Lead Product Designer, UX Researcher</span>
                  </div>
                  <div>
                    <span className="font-medium text-gray-700">Team:</span>
                    <span className="ml-2 text-gray-600">2 Engineers, 1 Data Scientist, 1 PM</span>
                  </div>
                  <div>
                    <span className="font-medium text-gray-700">Methodologies:</span>
                    <div className="mt-1 space-x-2">
                      <span className="px-2 py-1 bg-blue-100 text-blue-700 rounded text-sm">Design Thinking</span>
                      <span className="px-2 py-1 bg-green-100 text-green-700 rounded text-sm">Agile</span>
                      <span className="px-2 py-1 bg-purple-100 text-purple-700 rounded text-sm">User-Centered Design</span>
                    </div>
                  </div>
                  <div>
                    <span className="font-medium text-gray-700">Overview:</span>
                    <p className="mt-1 text-gray-600 text-sm">
                      Designed an AI-powered platform that helps investors make data-driven decisions through advanced
              ...
              <div className="max-w-lg w-full p-8">
                ...
                <div className="space-y-3">
                  <div>
                    <span className="font-medium text-gray-700">Timeline:</span>
                    <span className="ml-2 text-gray-600">Mar 2023 - Ongoing</span>
                  </div>
                  <div>
                    <span className="font-medium text-gray-700">Status:</span>
                    <span className="ml-2 text-gray-600">Active</span>
                  ...
                  <div>
                    <span className="font-medium text-gray-700">My Role:</span>
                    <span className="ml-2 text-gray-600">Senior UX Designer</span>
                  </div>
                  <div>
                    <span className="font-medium text-gray-700">Team:</span>
                    <span className="ml-2 text-gray-600">3 Engineers, 1 Product Manager</span>
                  </div>
                </div>
              </div>
            ) : (
