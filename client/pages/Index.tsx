        ...
        <header className="h-12 bg-white border-b-2 border-black flex items-center justify-between px-2 md:px-4 relative z-10">
          ...
          <div className="flex items-center gap-1 md:gap-3">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="hover:opacity-80 p-1 flex items-center"
              style={{ cursor: "pointer" }}
            >
              <img
                src="https://cdn.builder.io/api/v1/image/assets%2F856fd2123e2d4729ba1bfb1e222ef2c1%2Fe999355e4bdc4e449dd8d4e136e1765c?format=webp&width=800"
                alt="Instagram"
