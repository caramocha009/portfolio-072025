        ...
        <header className="h-12 bg-white border-b-2 border-black flex items-center justify-between px-2 md:px-4 relative z-10">
          ...
          <div className="flex items-center gap-1 md:gap-3">
            ...
            >
              ...
              >
                <path
                  d="M12 2c2.717 0 3.056.01 4.122.06 1.065.05 1.79.217 2.428.465.684.264 1.065.547 1.532 1.013.466.467.75.848 1.013 1.532.248.638.415 1.363.465 2.428.05 1.066.06 1.405.06 4.122s-.01 3.056-.06 4.122c-.05 1.066-.217 1.79-.465 2.428-.264.684-.548 1.065-1.013 1.532-.467.466-.848.75-1.532 1.013-.638.248-1.363.415-2.428.465-1.066.05-1.405.06-4.122.06s-3.056-.01-4.122-.06c-1.066-.05-1.79-.217-2.428-.465-.684-.264-1.065-.548-1.532-1.013-.466-.467-.75-.848-1.013-1.532-.248-.638-.415-1.363-.465-2.428-.05-1.066-.06-1.405-.06-4.122s.01-3.056.06-4.122c.05-1.066.217-1.79.465-2.428.264-.684.548-1.065 1.013-1.532.467-.466.848-.75 1.532-1.013.638-.248 1.363-.415 2.428-.465 1.066-.05 1.405-.06 4.122-.06zm0-2c-2.717 0-3.056.01-4.122.06-1.066.05-1.79.217-2.428.465C3.552.264 3.05.548 2.566 1.032 2.082 1.516 1.798 2.018 1.534 2.45c-.248.638-.415 1.363-.465 2.428C1.01 6.944 1 7.283 1 12s.01 3.056.06 4.122c.05 1.066.217 1.79.465 2.428.264.684.548 1.065 1.013 1.532.467.466.848.75 1.532 1.013.638.248 1.363.415 2.428.465 1.066.05 1.405.06 4.122.06s3.056-.01 4.122-.06c1.066-.05 1.79-.217 2.428-.465.684-.264 1.065-.548 1.532-1.013.466-.467.75-.848 1.013-1.532.248-.638.415-1.363.465-2.428.05-1.066.06-1.405.06-4.122s-.01-3.056-.06-4.122c-.05-1.066-.217-1.79-.465-2.428-.264-.684-.548-1.065-1.013-1.532-.467-.466-.848-.75-1.532-1.013-.638-.248-1.363-.415-2.428-.465-1.066-.05-1.405-.06-4.122-.06z"
                  fill="#5656E9"
                />
                <path
                  d="M12 6a6 6 0 100 12 6 6 0 000-12zm0 9.91A3.91 3.91 0 118.09 12 3.91 3.91 0 0112 15.91z"
                  fill="#5656E9"
                />
                <circle cx="18.406" cy="5.594" r="1.405" fill="#5656E9" />
              </svg>
            </a>
          </div>
        </header>
