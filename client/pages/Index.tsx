        ...
        <div className="text-black px-6 pt-6 pb-6 overflow-y-auto">
          <div className="flex gap-6 items-start justify-center">
            ...
            <div className="flex-1 text-sm sm:text-base leading-relaxed space-y-4">
              ...
              <p>
                I'm a product designer who loves working in the intersection of
                meaning, emotion, and creativity. My work always comes back to
                one core question:
              </p>
              <p>
                <strong>Does this actually land with the person on the other
              ...
              <p>
                I'm less concerned about chasing perfect metrics and more focused
                on clarity, resonance, and impact. That means uncovering the real
                user problem and crafting solutions that feel effortless and
                human.
              </p>
              <p>
                I'm comfortable in the "messy middle" of the creative process:
                The place where ideas are half-formed, where pixels are
                close-but-not-quite, and where patience is required for a
                design solution to reveal itself.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="text-black px-6 pt-6 pb-6 overflow-y-auto">
          <div className="flex gap-6 items-start justify-center">
            ...
            <div className="flex-1 text-sm sm:text-base leading-relaxed space-y-4">
              ...
              <p>
                I'm a content creator who shapes long-form YouTube videos, podcast
                conversations, and short-form social content in a way that tells
                true, emotionally grounded stories.
              </p>
              <p>
                <strong>Does this actually land with the person on the other
                  side?</strong>
              ...
              <p>
                I'm especially drawn to themes of spirituality, self-development,
                and mindful living—but at the end of the day, I just love helping
                people express what matters to them, whether through a frame on a
                timeline.
              </p>
              <p>
                I'm comfortable in the "messy middle" of the creative process:
                The place where ideas are half-formed, where edits are
                close-but-not-quite, and where patience is required for a
                story to reveal itself.
              </p>
              <p>
                <strong>Do you have a story to tell?</strong>
                <br />
                Let's connect.
              </p>
            </div>
